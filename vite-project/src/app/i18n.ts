...
export const componentShowcaseText = {
  en: {
    ...
    codeLoading: 'Loading source code...',
    codeTab: 'Code',
    copyCode: 'Copy code',
    ...
    previewTab: 'Preview',
    proMembership: 'Pro',
    proOnlyDescription: 'Upgrade to a Pro membership to use this component preview.',
    proOnlyTitle: 'Pro members only',
    ...
    sourceUnavailable: 'Source code is not available for this preview yet.',
    usageSteps: [
      'Copy the component into the appropriate feature or shared component folder.',
      'Replace the sample state and labels with values from your screen.',
      'Check keyboard focus, mobile width, and dark mode before publishing.',
    ],
    usageTab: 'Usage',
  },
  ko: {
    checkMembership: '회원 등급 확인',
    clearPreviewSearch: '미리보기 검색어 지우기',
    codeCopied: '사용 코드를 복사했습니다.',
    codeLoading: '사용 코드를 불러오는 중입니다.',
    codeTab: '사용 코드',
    copyCode: '코드 복사',
    ...
    previewTab: '미리보기',
    proMembership: '프로',
    proOnlyDescription: '이 컴포넌트는 프로 등급 회원만 사용할 수 있습니다.',
    proOnlyTitle: '프로 회원 전용',
    removeSaved: '저장 해제',
    ...
    sourceFile: '원본 파일',
    sourceUnavailable: '아직 이 미리보기의 사용 코드가 준비되지 않았습니다.',
    usageSteps: [
      '코드를 기능 폴더나 공용 컴포넌트 폴더에 추가합니다.',
      '샘플 상태와 문구를 실제 화면에서 사용하는 값으로 바꿉니다.',
      '키보드 포커스, 모바일 너비, 다크 모드를 확인한 뒤 적용합니다.',
    ],
    usageTab: '사용법',
  },
} as const;
...
const routeCopy: Record<AppLanguage, Record<string, LocalizedRouteCopy>> = {
  ...
  ko: {
    ...
    projects: { label: '프로젝트', description: '저장한 작업 자료를 개인 프로젝트별로 묶어 관리합니다.', keywords: ['프로젝트', '즐겨찾기', '보관'] },
    security: { label: '보안', description: '계정 인증 상태, 비밀번호와 최근 보안 활동을 관리합니다.', keywords: ['보안', '비밀번호', '로그인'] },
    workspace: { label: '워크스페이스', description: '저장한 작업을 계정에 동기화하고 버전별로 복구합니다.', keywords: ['동기화', '백업', '복구'] },
    ...
    '/workspace': { label: '워크스페이스', description: '저장한 작업을 계정에 동기화하고 버전별로 복구합니다.', keywords: ['동기화', '백업', '복구'] },
    '/projects': { label: '프로젝트', description: '저장한 작업 자료를 개인 프로젝트별로 묶어 관리합니다.', keywords: ['프로젝트', '즐겨찾기', '보관'] },
    '/security': { label: '보안 센터', description: '계정 인증 상태, 비밀번호와 최근 보안 활동을 관리합니다.', keywords: ['보안', '비밀번호', '로그인'] },
    '/account': { label: '내 계정', description: '계정 정보와 현재 권한을 확인합니다.', keywords: ['회원', '프로필'] },
    '/auth/login': { label: '로그인', description: '이메일 계정으로 로그인합니다.', keywords: ['계정', '인증'] },
    '/auth/signup': { label: '회원가입', description: '새 일반 회원 계정을 만듭니다.', keywords: ['가입', '계정'] },
    '/admin': { label: '관리자', description: '회원 권한과 사이트 운영 상태를 관리합니다.', keywords: ['운영', '권한'] },
    '/admin/users': { label: '회원 관리', description: '회원 목록과 권한 등급을 관리합니다.', keywords: ['회원', '권한'] },
    '/admin/settings': { label: '사이트 설정', description: '회원가입, 메뉴 노출과 페이지 접근 등급을 관리합니다.', keywords: ['운영', '메뉴', '점검'] },
    '/admin/activity': { label: '활동 기록', description: '로그인과 주요 운영 변경 기록을 확인합니다.', keywords: ['로그', '기록', '보안'] },
    '/tools': { label: '도구', description: '제작, 변환, 편집 작업을 빠르게 처리하는 작은 도구 모음입니다.', keywords: ['툴', '유틸리티'] },
    ...
    '/tools/mock-api-studio': { label: 'Mock API Studio', description: '목 엔드포인트를 설계하고 fetch/MSW 코드를 바로 복사합니다.', keywords: ['api', '목', 'fetch', 'msw'] },
