...
const interactivePreviewText = {
  en: {
    ...
    modal: {
      ...
      description: "After deletion, this report cannot be restored.",
      open: "Open modal",
      status: "Status",
  ...
  ko: {
    ...
    modal: {
      ...
      delete: "삭제",
      deleted: "보고서 삭제됨",
      description: "삭제하면 이 보고서는 다시 복구할 수 없습니다.",
      open: "모달 열기",
      status: "상태",
      title: "이 보고서를 삭제할까요?",
      waiting: "확인 대기 중",
...
export function AnimatedLineChartPreview() {
...
export function AnimatedTogglePreview() {
  const { language } = useLanguage();
  const text = interactivePreviewText[language].animation;
